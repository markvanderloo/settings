---
title: "Options management with the options package"
author: "Mark van der Loo"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Options management with the options package}
  %\VignetteEngine{knitr::rmarkdown}
  %\usepackage[utf8]{inputenc}
---

The ```options``` package is aimed to bring easy-to-use, yet powerful options management to R. 

- For **users** it brings an easy way to reset option values to defaults.
- For **R-programmers** and package developers it offers the possibility to easily handle multiple levels of local vs global option settings.
...
my_options()
```
You may pass an arbitrary number of such ```[key]=[value]``` pairs. If you want to define an option without a default value, just set its value to \code{NULL}.
...
#'
#' @export
pkg_reset() options::reset(MYPKGOPTIONS)
```

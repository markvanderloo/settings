...
-->
Options management with the options package
===========================================

_Mark van der Loo_ ```Sys.Date()```


The ```options``` package is aimed to bring easy-to-use, yet powerful options management to R. In particular,
...
With the ```options``` package you can create local options as follows. First, we create a global options
manager.
```{r}
